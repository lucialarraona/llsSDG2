...
PI_THREAD (thread_explora_teclado_PC) { //TECLADO PC
	int teclaPulsada;
...
int main ()
{
	...
	sistema.player.tmr_duracion_nota = tmr_new(timer_player_duracion_nota_actual_isr);
	sistema.torreta.tmr_duracion_disparo =tmr_new(timer_duracion_disparo_isr); //a�adido el dia 30 abril
...
/*
		...
		fsm_t* servo_fsm = fsm_new (WAIT_START,servo, &(sistema.torreta));
